...
echo '
SELECT lawstruct.id AS id, lawstruct.section AS section, lawstruct.edition_id AS edition, lawstruct.catch_line AS catch_line, lawstruct.repealed AS repealed, lawstruct.text AS text, lawstruct.structure_full AS structure FROM
